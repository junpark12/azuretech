...
<figcaption><span class="capture-meta">Captured $(Encode $portalScreenshots.capturedOn) &middot; Identifiers redacted &middot; Open image for full size</span>$(Encode $image.caption)</figcaption>
</figure>
"@
